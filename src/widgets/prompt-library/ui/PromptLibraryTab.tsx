...
const MOCK_PROMPTS: PromptItem[] = [
  { id: "1", title: "요약하기", body: "다음 내용을 3문장 이내로 요약해 주세요.", category: "요약" },
  {
    id: "2",
    title: "번역하기",
    body: "다음 텍스트를 자연스러운 한국어로 번역해 주세요.",
    category: "번역",
  },
  {
    id: "3",
    title: "코드 설명",
    body: "아래 코드가 하는 일을 단계별로 설명해 주세요.",
    category: "개발",
  },
  {
    id: "4",
    title: "이메일 초안",
    body: "다음 요점을 바탕으로 전문적인 이메일 초안을 작성해 주세요.",
    category: "작성",
  },
];
      ...
      <div className="rounded-2xl border border-slate-800/80 bg-slate-900/50 p-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            <PromptEditor value={selected?.body ?? ""} onChange={() => {}} readOnly={!!selected} />
          </div>
        </div>
      </div>
    </div>
